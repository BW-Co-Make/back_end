...
| Name        | Type    | Required  | Description                                             |
| ----------- | ------- | --------- | ------------------------------------------------------  |
| ID          | Number  | Yes       | Issue ID, generated by DB must be provided by client     |
| Title       | String  | Yes       | Changes, if any                                         |
| Password    | String  | Yes       | Changes, if any                                         |

##### Example
Example of interpolation of issue:
`https://co-make-bw.herokuapp.com/api/issues/${issuesIDhere}`
